...
public class RestauranteApplication {
	...
	// Agregar las clases de controladores y servicios necesarios para el
	// funcionamiento del Restaurante.
	// Por ejemplo, RestController, PlatoService, PlatoController, etc.
	// También deben estar configuradas las rutas en la clase
	// RestauranteApplication.
	// Para probar el funcionamiento del Restaurante, usar Postman o un cliente
	// HTTP.
